...
\begin{document}
	...
	\begin{figure}[H]
		\centering{}
		\includegraphics{img/window-controller/circuit.png} %TO BE MODIFIED
	...
	\newline To synchronize the ESP time with current date and time I relied on the \href{time.nist.gov}{\textit{United States National Institute of Standards and Technology time server}}, as suggested by \href{https://www.programmingelectronics.com/esp32-time-servers/}{\textit{this guide page}}.
	\section{Window Controller}
	\begin{figure}[H]
		\centering{}
